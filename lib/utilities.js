...
/**
 * Creates a new prototype, optionally inheriting from `parent`.
 *
 * Prototypes created with this method will have a method named `parent()`, which gives easy access to the parent prototype.
 *
 * @param {Function|Object} [parent=Object.prototype] Inherit from this prototype.
 * @param {Object}           proto                    The methods to add in the new prototype.
 * @param {Function}        [proto.constructor]       The constructor method.
 * @returns {Function}
 */
exports.klass = function klass(parentProto, proto) {
    var constructor;
    ...
    if (typeof(parentProto) === 'function') {
    ...
    constructor.prototype.parent = function parent() {
